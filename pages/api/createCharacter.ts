...
export default async function handler(req: IncomingMessage & any, res: ServerResponse & any): Promise<void> {
  try {
    ...
    queries.push({
      query: `INSERT INTO characters (user_id,name,gender,portrait_url,class_name,class_id,subclass_id,level,strength,intelligence,will,dexterity,constitution,charisma,xp,hp,hit_dice,location_id,maintenance_date,maintenance_paid,abilities,languages) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
      values: [
        b.user_id,
        b.name,
        b.gender,
