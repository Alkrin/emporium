...
export const ClassBattlegoatGatecrasher: CharacterClass = {
  ...
  classFeatures: [
    ...
    { def: BattlegoatGatecrasherDungeonScarred },
    { def: BattlegoatGatecrasherInvincibleDigestion },
    { def: BattlegoatGatecrasherMightyKidneys },
    { def: BattlegoatGatecrasherRedEyed },
    { def: BattlegoatGatecrasherRuneCarvedHorns },
    { def: BattlegoatGatecrasherSteelWool },
    { def: ProficiencyLanguage, subtypes: ["Goat"] },
  ],
