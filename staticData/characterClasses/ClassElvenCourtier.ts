...
export const ClassElvenCourtier: CharacterClass = {
  ...
  savingThrows: {
    [SavingThrowType.Paralysis]: [12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7],
    [SavingThrowType.Death]: [13, 13, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8],
    [SavingThrowType.Blast]: [16, 16, 15, 15, 14, 14, 13, 13, 12, 12, 11, 11],
    [SavingThrowType.Implements]: [14, 14, 13, 13, 12, 12, 11, 11, 10, 10, 9, 9],
