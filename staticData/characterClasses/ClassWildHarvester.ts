...
export const ClassWildHarvester: CharacterClass = {
  ...
  classFeatures: [
    ...
    { def: ProficiencyAlchemy, rank: 1, minLevel: 1 },
    { def: ProficiencyAnimalHusbandry, rank: 1, minLevel: 1 },
    { def: ProficiencyMagicalEngineering, rank: 1, minLevel: 1 },
    { def: WildHarvesterBoundToNature, rank: 1, minLevel: 9 },
    { def: WildHarvesterConnectionToNature, rank: 1, minLevel: 3 },
    { def: WildHarvesterNaturallyStealthy, rank: 1, minLevel: 5 },
    { def: WildHarvesterNaturalTactics, rank: 1, minLevel: 2 },
    { def: WildHarvesterSeenItAll, rank: 1, minLevel: 7 },
    { def: WildHarvesterWorldConnection, rank: 1, minLevel: 4 },
