...
export const ClassBarbarianJutland: CharacterClass = {
  name: "Barbarian, Jutland",
  hitDieSize: 8,
  hpStep: 2,
  ...
  weaponStyles: [WeaponStyle.OneHandOnly, WeaponStyle.OneHandAndShield, WeaponStyle.TwoHanded],
  ...
  classFeatures: [
    ...
    { def: ProficiencyClimbing, rank: 1, minLevel: 1 },
