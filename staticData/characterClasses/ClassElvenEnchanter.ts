...
export const ClassElvenEnchanter: CharacterClass = {
  ...
  cleaveMultiplier: 0,
  savingThrows: {
    [SavingThrowType.Paralysis]: [12, 12, 12, 11, 11, 11, 10, 10, 10, 9, 9, 9],
    [SavingThrowType.Death]: [13, 13, 13, 12, 12, 12, 11, 11, 11, 10, 10, 10],
    [SavingThrowType.Blast]: [15, 15, 15, 14, 14, 14, 13, 13, 13, 12, 12, 12],
    [SavingThrowType.Implements]: [11, 11, 11, 10, 10, 10, 9, 9, 9, 8, 8, 8],
