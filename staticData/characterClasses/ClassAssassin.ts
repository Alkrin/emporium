...
export const ClassAssassin: CharacterClass = {
  name: "Assassin",
  hitDieSize: 6,
  hpStep: 2,
  ...
  savingThrows: {
    ...
    [SavingThrowType.Death]: [13, 13, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7],
    [SavingThrowType.Blast]: [16, 16, 15, 15, 14, 14, 13, 13, 12, 12, 11, 11, 10, 10],
    [SavingThrowType.Implements]: [14, 14, 13, 13, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8],
  ...
  levelBasedSkills: [
    {
      ...
      tooltip:
        "Only available when in Leather armor or lighter.  In order to backstab, the character must first catch an opponent unawares, either by surprise or by " +
    ...
    },
    {
      ...
      tooltip: "Only available when in Leather armor or lighter.",
    },
    {
