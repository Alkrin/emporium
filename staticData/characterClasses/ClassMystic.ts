...
export const ClassMystic: CharacterClass = {
  ...
  hitDieSize: 6,
  hpStep: 2,
  primeRequisites: [CharacterStat.Wisdom, CharacterStat.Dexterity, CharacterStat.Constitution, CharacterStat.Charisma],
  statRequirements: {},
  ...
  cleaveMultiplier: 1,
  savingThrows: {
    [SavingThrowType.PetrificationAndParalysis]: [15, 14, 14, 13, 12, 12, 11, 10, 10, 7, 6, 6, 5, 4],
    [SavingThrowType.PoisonAndDeath]: [14, 13, 13, 12, 11, 11, 10, 9, 9, 6, 5, 5, 4, 3],
    [SavingThrowType.BlastAndBreath]: [16, 15, 15, 14, 13, 13, 12, 11, 11, 8, 7, 7, 6, 5],
    [SavingThrowType.StaffsAndWands]: [16, 15, 15, 14, 13, 13, 12, 11, 11, 8, 7, 7, 6, 5],
  ...
  classFeatures: [
    ...
    { def: MysticCommandOfVoice },
    { def: MysticGracefulFightingStyle },
    { def: MysticMeditativeFocus },
    { def: MysticMindful },
    { def: MysticPerceiveIntentions },
    { def: MysticPerfectionOfBody },
    { def: MysticProbabilityTrance },
    { def: MysticPurityOfBodyAndSoul },
    { def: MysticSpeedOfThought },
    { def: MysticStrengthOfSpirit },
    { def: MysticWholenessOfBody },
