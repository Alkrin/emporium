...
export const ExplorerExperienceAndHardiness: AbilityOrProficiency = {
  id: "Experience And Hardiness.Explorer",
  name: "Experience And Hardiness",
  description: [
    "When an explorer reaches 5th level (Guide), his experience " +
